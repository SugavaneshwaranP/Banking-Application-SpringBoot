...
<head>
    ...
    <title>Fixed Deposit — XYZ Bank</title>
    ...
    <style>
        :root{--bg-primary:#0a0e27;--bg-card:rgba(255,255,255,0.04);--bg-card-hover:rgba(255,255,255,0.08);
            ...
            --gradient-accent:linear-gradient(135deg,#7c3aed,#00b4d8);--radius:16px;}
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        ...
        .bg-mesh{position:fixed;top:0;left:0;width:100%;height:100%;z-index:0;pointer-events:none;
            background:radial-gradient(ellipse 60% 50% at 40% 40%,rgba(124,58,237,0.08) 0%,transparent 60%),
            radial-gradient(ellipse 50% 50% at 70% 70%,rgba(0,212,170,0.06) 0%,transparent 60%);}
        ...
        .card-header h1 .gradient{background:var(--gradient-accent);-webkit-background-clip:text;
            -webkit-text-fill-color:transparent;background-clip:text;}
        .card-header p{color:var(--text-muted);font-size:.9rem;margin-top:.5rem;line-height:1.6;}

        /* Rate Highlight */
        .rate-highlight{background:rgba(124,58,237,0.1);border:1px solid rgba(124,58,237,0.2);
            border-radius:12px;padding:1.5rem;text-align:center;margin-bottom:1.5rem;}
        .rate-label{font-size:.8rem;font-weight:600;color:var(--accent-3);text-transform:uppercase;letter-spacing:1px;}
        .rate-value{font-size:2.5rem;font-weight:900;background:var(--gradient-accent);-webkit-background-clip:text;
    ...
    <div class="wrapper">
        ...
        <div class="card">
            <div class="card-header">
                <div class="icon">&#128142;</div>
                <h1>Fixed <span class="gradient">Deposit</span></h1>
                <p>A safe and steady way to grow your money. Lock your funds for a specific period and earn higher interest rates.</p>
            </div>

            <div class="rate-highlight">
                <div class="rate-label">Interest Rate Up To</div>
                <div class="rate-value">6.5%</div>
            ...
            <div class="features">
                <div class="feature">
                    ...
                    <span class="f-text"><strong>Tenure:</strong> 7 days to 10 years</span>
                </div>
                <div class="feature">
                    <span class="f-icon">&#128176;</span>
                    <span class="f-text"><strong>Minimum Deposit:</strong> &#8377;5,000</span>
                </div>
                <div class="feature">
                    <span class="f-icon">&#128275;</span>
                    <span class="f-text"><strong>Premature Withdrawal:</strong> Allowed with penalty</span>
                </div>
                <div class="feature">
                    <span class="f-icon">&#128260;</span>
                    <span class="f-text"><strong>Auto Renewal:</strong> Available</span>
                </div>
                <div class="feature">
                    <span class="f-icon">&#128737;</span>
                    <span class="f-text"><strong>Tax Benefits:</strong> Available under Section 80C (5-year FD)</span>
                </div>
            </div>
